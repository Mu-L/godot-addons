...
Find the releases [here](https://github.com/kenyoni-software/godot-addons/releases/tag/latest) or add it to your Library in the [Godot Store](https://store-beta.godotengine.org/publisher/kenyoni/).
